        ...
        <tbody>
            @foreach ($categories as $category)
                <tr>
                    ...
                    <td>
                        <a href="#" class="inline-text" data-pk="{{ $category->id }}" data-name="name" data-type="text" data-title="name">{{ $category->name }}</a><br>
                        <a href="#" class="inline-text" data-pk="{{ $category->id }}" data-name="slug" data-type="text" data-title="slug">{{ $category->slug }}</a>

                    </td>
                    <td>
                        <a href="#" class="inline-text" data-pk="{{ $category->id }}" data-name="icon" data-type="text" data-title="icon">{!! $category->icon !!}</a>
                    </td>
                    <td>
                    ...
                    <td>
                        <form action="{{ route('admin.categories.update',$category->id) }}" method="POST">
                            ...
                            <select class="formcontrol" onchange="this.form.submit()" name="locate">
                                ...
                                <option value="4" {{ ($category->locate == '4') ? 'selected' : '' }}>
                                    Tin tức
                                </option>
                            </select>
                        </form>
                    ...
                    <td>
                        <a href="#" class="inline-text" data-pk="{{ $category->id }}" data-name="text" data-type="text" data-title="text">{{ $category->text }}</a>
                    </td>
                    <td>
                        <a href="#" class="inline-text" data-pk="{{ $category->id }}" data-name="area" data-type="textarea" data-title="area">{!! $category->area !!}</a>
                    </td>
                    <td>

        ...
        @foreach ($category->childs->sortBy('sort_id') as $category)
            <li>
                <div class="input-group">
                    <label class="form-control"><a href="#" class="inline-text" data-pk="{{ $category->id }}" data-name="sort_id" data-type="number" data-title="Enter sort number">{{ $category->sort_id }}</a>---{{ $category->name }}</label>

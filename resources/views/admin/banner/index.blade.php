    ...
    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
        ...
        <tbody>
            @foreach ($banners as $banner)
                <tr>
                    <td><a href="#" id="inline-sort" data-pk="{{ $banner->id }}" data-name="sort_by" data-type="number" data-title="Enter sort number">{{  $banner->sort_by ? $banner->sort_by : 1 }}</a></td>
                    <td>
                        @if ($banner->link == null)

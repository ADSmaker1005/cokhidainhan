...
class BannerController extends Controller
{
    ...
    public function update(Request $request,$id)
    {
        ...
        return redirect()->route('admin.banner.index')->with('warning','Cập nhật thành công !');
    }

    public function destroy($id)
    {
        Banner::FindOrFail($id)->delete();
        return redirect()->route('admin.banner.index')->with('danger','Deleted !');
    }
    public function inline(Request $request)
    {
        ...
        {
            return redirect()->route('admin.banner.index')->with('danger','Ajax inline error !');
        }
    }
